...
jv = driver.find_element(By.XPATH,'//*[@id="approvalTab"]/li[8]')
driver.execute_script("arguments[0].scrollIntoView();", jv)
jv.click()
time.sleep(4)

wait = WebDriverWait(driver, 10)  # Maximum wait time of 10 seconds
element = wait.until(EC.element_to_be_clickable((By.XPATH, "(//button[@id='first-contact-person'])[11]")))
element.click()
time.sleep(4)

# Adding internal users for approvals
