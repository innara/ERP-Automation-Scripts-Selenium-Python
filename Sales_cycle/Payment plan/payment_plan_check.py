...
element = driver.find_element(By.XPATH, '//*[@id="checkSalesPlan"]')
element.click()
driver.find_element(By.XPATH,'/html/body/div[10]/div/div[6]/button[1]').click()
time.sleep(10)
print('Successfully checked Payment plan')
myelement = driver.find_element(By.XPATH , '//*[@id="byPassApprove"]')
if myelement.is_displayed():
    driver.find_element(By.XPATH,"//a[@id='form1']").click()
else:
    print("Pending approvals you can not approve this file ")
driver.quit()
