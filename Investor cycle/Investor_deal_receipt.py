...
button.click()
try:
    deal = driver.find_element(By.XPATH, '//*[@id="main-menu-navigation"]/li[23]/ul/li[2]')
    driver.execute_script("arguments[0].scrollIntoView();", deal)
    wait = WebDriverWait(driver, 10)
    button = wait.until(EC.element_to_be_clickable((By.XPATH, '//*[@id="main-menu-navigation"]/li[23]/ul/li[2]')))
    button.click()
    time.sleep(2)
...
time.sleep(1)
driver.find_element(By.XPATH,'//*[@id="stakeholder-table_wrapper"]/div[1]/div[2]/div/div[2]/div/button[1]').click()
time.sleep(3)
# Creating deal receipt
dropdown_element = driver.find_element(By.XPATH, '//*[@id="deal_id"]')
dropdown = Select(dropdown_element)
dropdown.select_by_index(2)
selected_option = dropdown.first_selected_option
all_options = dropdown.options
time.sleep(2)
driver.find_element(By.XPATH,'//*[@id="doc_number"]').send_keys('ID-00123')
driver.execute_script("document.body.style.zoom='75%'")
