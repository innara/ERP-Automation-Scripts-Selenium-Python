...
time.sleep(5)
# Creatng intrest
driver.find_element(By.XPATH, '/html/body/div[3]/div[3]/div[4]/section/div/div/ul/li[5]').click()
interest = driver.find_element(By.XPATH,'//*[@id="crmData"]/form/ul/li[2]')
interest.click()
Add_new = driver.find_element(By.XPATH,'//*[@id="crm-interest-table_wrapper"]/div[1]/div[2]/div/button')
Add_new.click()
time.sleep(2)
driver.find_element(By.XPATH,'//*[@id="crm-interest-table_wrapper"]/div[1]/div[2]/div/div[2]/div/button').click()
interest_name = driver.find_element(By.XPATH, ' //*[@id="interestName"]')
interest_name.send_keys('For topmost floor for office use')
submit = driver.find_element(By.XPATH, ' //*[@id="interestsave-btn"]')
submit.click()
time.sleep(5)
driver.quit()
